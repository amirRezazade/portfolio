...
let projects = [
  {
    img: "/images/digi-media.jpg",
    name: "digi-media",
    desc: "سایت معرفی فیلم و سریال ایرانی و خارجی",
    languages: (
      <>
    ...
    repo: "https://github.com/amirRezazade/digi-media-NextJs",
    demo: "https://digi-media-next.netlify.app/",
    aos: "fade-left",
  },
  {
    img: "/images/digi-plus.jpg",
    name: "Digi-plus",
    ...
    repo: "https://github.com/amirRezazade/Digi-plus",
    demo: "https://digi-plus.netlify.app/",
    aos: "fade-up",
  },
  {
    img: "/images/dashboard.jpg",
    name: "Ecme",
    desc: "پنل ادمین وبسایت فروشگاهی",
    languages: (
      <>
        <span className="px-2.5 py-0.5 border rounded-full text-slate-300">API</span>
        <span className="px-2.5 py-0.5 border rounded-full text-cyan-400">Tailwind</span>
    ...
    repo: "https://github.com/amirRezazade/Dashboard",
    demo: "https://amirrezazade.github.io/Dashboard/",
    aos: "fade-right",
  },
  {
    img: "/images/play-host.jpg",
    name: "play-host",
    desc: "وبسایت زیبا و مدرن برای معرفی بازی در پلتفرم های مختلف",
    languages: (
      <>
        <span className="px-2.5 py-0.5 border rounded-full text-slate-300">API</span>
        <span className="px-2.5 py-0.5 border rounded-full text-cyan-400">Tailwind</span>
    ...
    repo: "https://github.com/amirRezazade/game-site",
    demo: "https://amirrezazade.github.io/game-site/",
    aos: "fade-left",
  },
  {
    img: "/images/eduport.jpg",
    name: "eduport",
    desc: "وبسایت آموزشی زیبا ( html , css , js )",
    languages: (
      <>
    ...
    repo: "https://github.com/amirRezazade/eduport",
    demo: "https://amirrezazade.github.io/eduport/",
    aos: "fade-up",
  },
];
    ...
    <section id="project" className="nav-control mt-10 sm:mt-15 md:my-20">
      <div className="container max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-7 mt-5 sm:mt-10 md:mt-18 px-8 sm:px-20 md:px-6">
          {projects.map((p) => (
            <div key={p.name} suppressHydrationWarning data-aos={p.aos} data-aos-duration="1000" className="">
                ...
                <div className="relative overflow-hidden bg-linear-to-br from-slate-900/90 to-slate-800/90 backdrop-blur-lg border border-white/10 shadow-2xl group-hover:border-purple-500/50 rounded-xl transition-all duration-300 hover:shadow-purple-500/20">
                  ...
                  <div className="relative p-5 z-10">
                    <div className="relative rounded-lg aspect-5/4 overflow-hidden">
                      <Image width={350} height={280} src={p.img} alt={p.name} className="w-full h-full object-cover" />
                    </div>
                    <div className="mt-4 space-y-3">
                      <h3 className="text-xl font-semibold bg-linear-to-r from-blue-200 from-50% to-violet-300 bg-clip-text text-transparent">{p.name}</h3>
                      <p className="text-gray-100 text-sm leading-relaxed line-clamp-2">{p.desc}</p>
                      <div className="flex items-center justify-end flex-wrap gap-2 pt-2 text-[10px]">{p.languages}</div>
                      <div className="pt-2 flex items-center justify-between">
                        <a className="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg bg-white/5 hover:bg-white/10 text-white/90 transition-all duration-200 hover:scale-105" href={p.repo} target="-blank">
                        ...
                        <a href={p.demo} target="_blank" rel="noopener noreferrer" className="inline-flex items-start gap-1.5 justify-center text-blue-400 hover:text-blue-300 transition-colors duration-200">
